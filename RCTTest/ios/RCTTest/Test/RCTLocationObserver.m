...
#define RCT_DEFAULT_LOCATION_ACCURCY kCLLocationAccuracyHundredMeters
...
+(RCTLocationOptions)RCTLocationOptions:(id)json
{
    ...
    double distanceFilter = options[@"distanceFilter"] == NULL ? RCT_DEFAULT_LOCATION_ACCURCY  : [RCTConvert double:options[@"distanceFilter"]] ?: kCLDistanceFilterNone;
    return (RCTLocationOptions){
        .timeout = [RCTConvert NSTimeInterval:options[@"timeout"]] ?: INFINITY,
        .maximumAge = [RCTConvert NSTimeInterval:options[@"maximumAge"]] ?: INFINITY,
        .accuracy = [RCTConvert BOOL:options[@"enableHighAccuracy"]] ? kCLLocationAccuracyBest : RCT_DEFAULT_LOCATION_ACCURCY,
     ...
     didUpdateLocations:(NSArray<CLLocation *> *)locations
{
    ...
    if (ABS(_locationManager.desiredAccuracy - RCT_DEFAULT_LOCATION_ACCURCY) > 0.000001) {
        _locationManager.desiredAccuracy = RCT_DEFAULT_LOCATION_ACCURCY;
    }
}
